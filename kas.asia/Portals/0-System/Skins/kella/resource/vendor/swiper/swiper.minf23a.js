...
var swiperLauncher= function(mod){
    ...
    mod.each(function(){
        if(!typeof $(this)[0].swiper) return ;
       ...
       function  MutationObserveridden(){ 
                  ...
                  //  if(e.hasClass("section-pagepiling")){
                  //      swiper_default["effect"] = "pagepiling";
                  //  }
                    ...
                    if(!e.hasClass("section-slider") && !e.hasClass("section-pagepiling")){
                    ...
                    if(e.siblings(".thumbnail").length){
                        swiper.on('transitionStart', function() {
                            if(e.siblings(".thumbnail")[0] && typeof e.siblings(".thumbnail")[0].swiper != "undefined" ){
                                e.siblings(".thumbnail")[0].swiper.slideTo(swiper.realIndex);   
                            }
                        })
                    }
                   ...
                   if(e.find(".css3-animate,.animation").length){
                        swiper.on('transitionStart', function() {
                            $(swiper.slides[swiper.previousIndex]).siblings().find(".css3-animate,.animation").removeClass("animated");
                        })
                        swiper.on('transitionEnd', function() {
                            if (typeof addJsAnimation != "undefined") {
                                $(swiper.slides[swiper.previousIndex]).find(".css3-animate,.animation").removeClass("animated");
                                addJsAnimation($(swiper.slides[swiper.activeIndex]).find(".css3-animate,.animation"));
                            }
                        })
                    }

                    if(e.find(".img-Lazy").length){
                        
                        $(swiper.slides[swiper.activeIndex]).find(".img-Lazy").each(function(){ 
                            $(this).attr("src", $(this).data("src"));
                            $(this).siblings(".Lazy-loading,.Lazy-loading-transparent").remove();
                        })

                        swiper.on('transitionStart', function() {
                         var img = $(swiper.slides[swiper.activeIndex]).find(".Lazy-loading + .img-Lazy,.Lazy-loading-transparent + .img-Lazy");
                                img.each(function(){
                                    $(this).attr("src", $(this).data("src"));
                                    $(this).siblings(".Lazy-loading,.Lazy-loading-transparent").remove();
                                })
                    ...
                    if( e.hasClass("swiper-ourTeam02") ){

                        setTimeout(function(){
                            e.find(".swiper-pagination").css("max-width",e.find(".swiper-slide-active>.pic").outerWidth(true));
                        },0)
...
jQuery(document).ready(function () {
    ...
    $(".swiper-navigation-button").each(function(){
        var swiper = $(this).parents(".is-boxes").find(".swiper-container").eq(0);
